                                ...
                                <div class="section">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            ...
                                            <label for="outros_sintomas_input">Outros sintomas (obrigatório caso tenha outros sintomas)</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col s12">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col l6 s12">
                                                    ...
                                                    <p>
                                                        <label>
                                                            <input name="doencas[]" value="Nenhuma doença prévia" type="checkbox" class="filled-in" />
