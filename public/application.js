...
function init_form_validation() {
	...
	validator = $('#covid-19-diagnosis-form').validate({
        ...
        submitHandler: function(form) {
        	var icon = null, title_color = null, message = null, hospital = null;
        	switch(analyze_data()) {
        		case 'suspeito-covid':
        			icon = 'warning';
        			title_color = 'orange';
            ...
            var back_element = '<p class="center"><a href="' + APP_URL + '">Voltar ao formulário</a></p>';

            // Submeter informações para armazenamento
            $.ajax({
				type: 'POST',
				url: '/store',
				data: $('#covid-19-diagnosis-form').serialize() + '&encaminhado_hospital=' + hospital,
				dataType: 'json'
			});
